  ...
  return (
    <Container maxWidth="false" component="section" className={classes.imageListSection}>
      ...
      <ImageList className={classes.imageList} rowHeight={150} gap={5} cols={6}>
        ...
        <ImageListItem className={classes.imageListItem} cols={2} rows={2}>
        ...
        <ImageListItem className={classes.imageListItem} cols={1} rows={1}>
        ...
        <ImageListItem className={classes.imageListItem} cols={1} rows={2}>
