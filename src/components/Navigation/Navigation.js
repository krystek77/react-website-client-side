              ...
              <ul className="submenu__list">
                  ...
                  <div className={`handy-submenu ${activeHandySubmenu === '11' ? 'handy-submenu--visible' : ''}`}>
                    ...
                    <ul className="handy-submenu__list">
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>bębnowe o załadunku czołowym</span>
                          <b>PB</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                      ...
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>bębnowe o załadunku bocznym</span>
                          <b>BP</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>specjalistyczne, bębnowe o załadunku czołowym</span>
                          <b>PC</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>specjalistyczne, bębnowe o załadunku bocznym</span>
                          <b>PB</b>
                        </Link>
                      </li>
                    </ul>
                    ...
                    <ul className="handy-submenu__list">
                      <li className="handy-submenu__item">
                        <Link
                          ...
                          className="handy-submenu__link"
                          to="/produkty/wirówki#c8"
                        >
                          <span>wirówka pralnicza</span>
                          <b>C8</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                    ...
                    <ul className="handy-submenu__list">
                      ...
                      <li className="handy-submenu__item">
                        <Link
                          ...
                          className="handy-submenu__link"
                          to="/produkty/suszarki#bębnowe-tx"
                        >
                          <span>bębnowe</span>
                          <b>TX</b>
                        </Link>
                      ...
                      <li className="handy-submenu__item">
                        <Link
                          ...
                          className="handy-submenu__link"
                          to="/produkty/suszarki#bębnowe-dx"
                        >
                          <span>bębnowe</span>
                          <b>DX</b>
                        </Link>
                  ...
                  <div className={`handy-submenu ${activeHandySubmenu === '15' ? 'handy-submenu--visible' : ''}`}>
                    ...
                    <ul className="handy-submenu__list">
                      ...
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>walcowe ze składarką wzdłużną</span>
                          <b>IF50</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>walcowe ze składarką wzdłużną i wprowadzarką</span>
                          <b>IFF50</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                ...
                <li className="submenu__item">
                  ...
                  <div className={`handy-submenu ${activeHandySubmenu === '16' ? 'handy-submenu--visible' : ''}`}>
                    ...
                    >
                      Urządzenia do pralni z tzw. barierą higieny
                    </Link>
                    <ul className="handy-submenu__list">
                      <li className="handy-submenu__item">
                        <Link
                ...
                <li className="submenu__item">
                  ...
                  <div className={`handy-submenu ${activeHandySubmenu === '17' ? 'handy-submenu--visible' : ''}`}>
                    ...
                    >
                      Zestawy do prasowania ręcznego, prasy
                    </Link>
                    <ul className="handy-submenu__list">
                      <li className="handy-submenu__item">
                        <Link
                        ...
                        >
                          <span>zestaw do prasowania ręcznego</span>
                          <b>EB3</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                  ...
                  <div className={`handy-submenu ${activeHandySubmenu === '18' ? 'handy-submenu--visible' : ''}`}>
                    ...
                    <ul className="handy-submenu__list">
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>wózek na suche pranie</span>
                          <b>WS-150</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>wózek na mokre pranie</span>
                          <b>WM-150</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                      ...
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>wózek z podnoszonym dnem</span>
                          <b>WPD-400</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                  ...
                  <div className={`handy-submenu ${activeHandySubmenu === '21' ? 'handy-submenu--visible' : ''}`}>
                    ...
                    <ul className="handy-submenu__list">
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>pralnicowirówki wysokoobrotowe</span>
                          <b>FX</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>pralnicowirówki normalnoobrotowe</span>
                          <b>RX</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>pralnicowirówki szybkoobrotowe</span>
                          <b>RX</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                      ...
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>małe, profesjonalne pralnicowirówki</span>
                          <b>SFC</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
                        ...
                        >
                          <span>małe, profesjonalen suszarki</span>
                          <b>SDC</b>
                        </Link>
                      </li>
                      <li className="handy-submenu__item">
